# Autogenerated wrapper script for Blosc_jll for x86_64-apple-darwin14-cxx11
export libblosc
...
const libblosc_splitpath = ["lib", "libblosc.1.14.3.dylib"]
...
const libblosc = "@rpath/libblosc.1.dylib"
