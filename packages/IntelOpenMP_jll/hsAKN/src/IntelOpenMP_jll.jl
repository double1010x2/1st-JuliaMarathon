...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import IntelOpenMP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1d5cc7b8-4909-519e-a0f8-d0f5ad9712d0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "IntelOpenMP", artifacts_toml) for e in artifacts["IntelOpenMP"]]
...
if best_platform === nothing
    @debug("Unable to load IntelOpenMP; unsupported platform $(triplet(platform_key_abi()))")
else
