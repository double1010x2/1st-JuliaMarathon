...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Lz4_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5ced341a-0733-55b8-9ab6-a4889d929147"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Lz4", artifacts_toml) for e in artifacts["Lz4"]]
...
if best_platform === nothing
    @debug("Unable to load Lz4; unsupported platform $(triplet(platform_key_abi()))")
else
