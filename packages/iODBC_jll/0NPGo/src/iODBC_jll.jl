...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import iODBC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("80337aba-e645-5151-a517-44b13a626b79"))
platforms = [Pkg.Artifacts.unpack_platform(e, "iODBC", artifacts_toml) for e in artifacts["iODBC"]]
...
if best_platform === nothing
    @debug("Unable to load iODBC; unsupported platform $(triplet(platform_key_abi()))")
else
