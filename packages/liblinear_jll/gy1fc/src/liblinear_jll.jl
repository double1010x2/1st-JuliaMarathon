...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import liblinear_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("275f1f90-abd2-5ca1-9ad8-abd4e3d66eb7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "liblinear", artifacts_toml) for e in artifacts["liblinear"]]
...
if best_platform === nothing
    @debug("Unable to load liblinear; unsupported platform $(triplet(platform_key_abi()))")
else
