...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libsvm_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("08558c22-525a-5d2a-acf6-0ac6658ffce4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libsvm", artifacts_toml) for e in artifacts["libsvm"]]
...
if best_platform === nothing
    @debug("Unable to load libsvm; unsupported platform $(triplet(platform_key_abi()))")
else
