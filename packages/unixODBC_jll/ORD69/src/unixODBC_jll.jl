...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import unixODBC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1841a5aa-d9e2-579c-8226-32ed2af93ab1"))
platforms = [Pkg.Artifacts.unpack_platform(e, "unixODBC", artifacts_toml) for e in artifacts["unixODBC"]]
...
if best_platform === nothing
    @debug("Unable to load unixODBC; unsupported platform $(triplet(platform_key_abi()))")
else
